...
./../../../bin/HFO --defense-agents=2 --offense-agents=1 --offense-on-ball 11 --trials 500 --deterministic --headless --discrete=True --frames-per-trial 2000 --untouched-time 2000 &
sleep 5
